...
def importReportFile(sName, IDmap, iRate):
    ...
    reSampleBegin = re.compile("<samples unit=\"([0-9a-f]+)\" scheme=\"returns\">")    
...
if __name__ == '__main__':
    ...
    for index in range(len(rankList)):
        print mapSiteInfo[(tmpID[rankList[index][0]][0], 'returns')][tmpID[rankList[index][0]][1]], tmpID[rankList[index][0]][2], '0',  rankList[index][1]
